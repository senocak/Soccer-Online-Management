...
@Getter
@Setter
public class PlayerCreateDto extends BaseDto {
    @NotNull
    @Size(min = 3, max = 30)
    ...
    @Schema(example = "4f0ae046-5ca3-4dfa-9904-b836cf8c1ff0", description = "Identifier of the team", required = true, name = "team", type = "UUID")
    private UUID teamId;
}
